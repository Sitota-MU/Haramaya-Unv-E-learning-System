 <form id="signin_student" class="form-signin" method="post">
	<h4 class="form-signin-heading"><i class="icon-plus-sign"></i> Add Event</h4>
		...
		<input type="text" class="input-block-level" id="username" name="title" required pattern="[a-zA-Z0-9 ]{4,200}" oninvalid="setCustomValidity('title must be above four letter ')" onchange="try{setCustomValidity('')}catch(e){}"placeholder="Title" required/>
