	<div class="navbar navbar-fixed-top navbar-inverse">
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#">Welcome to: Online Tutorial Department Head Panel</a>
							<div class="nav-collapse collapse">
								<ul class="nav pull-right">
												<?php $query= mysql_query("select * from department where id = '$session_id'")or die(mysql_error());
