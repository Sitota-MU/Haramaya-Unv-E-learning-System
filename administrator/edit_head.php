    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_head_form.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Heads List</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <th></th>
										...
										<tbody>
												 <?php
                                    $teacher_query = mysql_query("select * from head ") or die(mysql_error());
									...
									<td width="30"><a href="edit_head.php<?php echo '?head_id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>
                                </tr>
                            <?php } ?>
