   <div class="row-fluid">
    <a href="instructor.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Instructor</a>
                        <!-- block -->
                        <div class="block">
...
<div class="control-group">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['Inst_id']; ?>" id="focusedInput" name="id" type="number"  onchange="try{setCustomValidity('')}catch(e){}" placeholder = "ID">
                                          </div>
                                        </div>
 ...
 mysql_query("update instructor set location = '$location',f_name='$fname',l_name='$lname',phone='$phone',username='$usename' ,email='$email' ,dep_name='$dep', password='$password'where Inst_id = '$get_id' ")or die(mysql_error());
 ?>
 		<script>
