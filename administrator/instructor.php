                                ...
                                <div class="span12">
                                    ...
                                    <td><?php echo $row['Inst_id']; ?></td> 
									 <td><?php echo $row['password']; ?></td> 
									     ...
									     <td width="120"><a href="de_activateh_inst.php<?php echo '?Inst_id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i>Activate</a></td>
									<?php }else{ ?>
									<td width="120"><a href="activateh_inst.php<?php echo '?Inst_id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> deactivate</a></td>		
