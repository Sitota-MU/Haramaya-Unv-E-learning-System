	...
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a href="inst_message.php">For Instructor</a>
										</li>
										<li class="active"><a href="student_message.php">For Student</a></li>
									</ul>
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="student_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysql_query("select * from student order by f_name");
											while($row = mysql_fetch_array($query)){
											
											?>
											
											<option value="<?php echo $row['student_id']; ?>"><?php echo $row['f_name']; ?> <?php echo $row['l_name']; ?> </option>
											<?php } ?>
                                            </select>
                                          </div>
                                        </div>
			...
			jQuery("#send_message_student").submit(function(e){
					...
					$.ajax({
						...
						var delay = 2000;
							setTimeout(function(){ window.location = 'inst_message.php'  }, delay);  
