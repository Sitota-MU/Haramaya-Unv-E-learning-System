	...
	<div class="row-fluid">
				      <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-plus-sign"></i> AdD Resource Materials</h4></div>
                            </div>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "upload_save1.php",
						data: formData,
						success: function(html){
							$.jGrowl("File Successfully  Added", { header: 'File Added' });
							window.location = 'add_text.php<?php echo '?id='.$get_id; ?>';
						},
						cache: false,
						contentType: false,
						processData: false
