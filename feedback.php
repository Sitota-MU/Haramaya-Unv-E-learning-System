...
if($submit=='Finish')
{
	mysql_query("delete from useranswer where stud_id='" . session_id() ."'") or die(mysql_error());
	unset($_SESSION[qn]);
...
<?php
include("header.php");
echo "<h1 class=head1> Feedback Test Question</h1>";
...
$rs=mysql_query("select * from useranswer where stud_id='" . session_id() ."'",$cn) or die(mysql_error());
