    ...
    <body>
		...
		$datee = date('y-m-d');
		 ...
		 $stu = "post";
				...
				mysql_query("insert into  post_noticee (date,deadline,head_id,post_title,post_content,Inst_id,usernam,status,statu)
				values('$date','$da','$session_id','$post_title','$post_content','$get_id','$id','$st','$stu') ")or die(mysql_error());	
		?>
									<script>
				...
				<div class="span4 row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 <?php
								 $query_announcement = mysql_query("select * from   post_noticee where head_id='$session_id'  order by date DESC
																	")or die(mysql_error());
