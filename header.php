...
<html class="no-js">
    <head>
        <title>HARAMAYA UNIVERSITY E_learning</title>
		<meta name="description" content="online tutorial">
		<meta name="keywords" content="online tutorial">
		<meta name="author" content="online tutorial">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
				<link href="admin/img/tr.jpg" rel="icon" type="image"> 
	            <link href="admin/css/bootstrap.css" rel="stylesheet" media="screen"/>
				 <link href="admin/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen"/>
