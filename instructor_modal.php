<?php include('header_lo.php'); ?>
  ...
  <form id="form1" name="login" method="POST" action="login_inst.php" onsubmit="return validateForm()">
 ...
 <div style="float:left;" ><strong><font color="white" size="2px">Instructor Login</font></strong></div>
