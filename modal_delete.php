					...
					<button name="delete_class" class="btn btn-danger"><i class="icon-check icon-large"></i> Yes</button>
								...
								<!-- group delete modal -->
					<div id="group_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
					...
					<div class="modal-body">
					<div class="alert alert-danger">
					<p>Are you sure you want to delete the group you check?.</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Close</button>
					<button name="delete_group" class="btn btn-danger"><i class="icon-check icon-large"></i> Yes</button>
					</div>
					</div>
