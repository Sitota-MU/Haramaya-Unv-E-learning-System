...
<?php $get_id = $_GET['id']; ?>
            ...
            <div class="row-fluid">
				...
				<div class="row-fluid">
						...
						<li>
							...
							<a href="my_course.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i>Add Video Resource</a>
    ...
    <div id='box'>
		<?php
			$query = mysql_query("SELECT * FROM videos where inst_course_id='$get_id'") or die( mysql_error());
