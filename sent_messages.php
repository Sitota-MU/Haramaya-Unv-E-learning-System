                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class=""><a href="inst_message.php"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class="active"><a href="sent_messages.php"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
									
								<?php
								 $query_announcement = mysql_query("select * from message_sent
																	LEFT JOIN instructor ON instructor.Inst_id = message_sent.reciever_id
