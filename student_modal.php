...
$client = new nusoap_client("http://localhost/registration/viewstudent.php?wsdl");
...
<?php include('header_lo.php'); ?>
  ...
  <form id="form1" name="login" method="POST"   action="login_stu.php" >
 ...
 <div style="float:left;" ><strong><font color="white" size="2px">Student Login</font></strong></div>
