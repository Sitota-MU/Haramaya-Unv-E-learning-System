...
{
	header("location: veiw_text_student.php");
}
echo $tid;
?>
...
$query="select * from quiz";
							$query = mysql_query("select *from quiz where course_code = '$course'  ")or die(mysql_error());
...
{	
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				echo "</table>";
				mysql_query("insert into result(stud_id,course_code,test_date,score) values('$session_id','$course','NOW()',$_SESSION[trueans])") or die(mysql_error());
...
session_destroy();
echo "Please <a href=view_text_student.php> Start Again</a>";

exit;
}
mysql_data_seek($rs,$_SESSION[qn]);
$row= mysql_fetch_row($rs);
echo "<form name=myfm method=post action=take_quiz.php>";
