...
if ($errflag) {
	...
	?>
<script>
alert('add Event successussfull');
</script>
   <script>
    ...
    if (($ext != "exe") && ($_FILES["uploaded_file"]["type"] != "application/x-msdownload")) {
        ...
        if (!file_exists($newname)) {
            ...
            if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
                ...
                $qry2 = "INSERT INTO files (fdesc,floc,fdatein,Inst_id,class_id,fname,uploaded_by) VALUES ('$filedesc','$newname',NOW(),'$session_id','$id_class','$name','$uploaded_by')";
			...
			/* 		window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>'; */
                    ...
                    if ($errflag) {
                        ...
                        session_write_close(); ?>
						<script>
alert('add Event successussfull1');
</script>
                           <script>
   window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>';
   </script>
   <?php
                ...
                if ($errflag) {
                    ...
                    session_write_close(); ?>
					<script>
alert('add Event successussfull2');
</script>
       <script>
   window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>';
   </script>
   ...
   <?php
            ...
            if ($errflag) {
                ...
                session_write_close(); ?>
				<script>
alert('add Event successussfull3');
</script>
       <script>
   window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>';
   </script>
   <?php
        ...
        if ($errflag) {
            ...
            session_write_close(); ?>
			<script>
alert('add Event successussfull4');
</script>
            <script>
   window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>';
   </script>
   <?php
    ...
    if ($errflag) {
        ...
        session_write_close(); ?>
		<script>
alert('add Event successussfull5');
</script>
       <script>
   window.location = 'downloadable.php<?php echo '?id='.$get_id;  ?>';
   </script>
